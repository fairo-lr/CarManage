...
<body>
    ...
    <table class="addTable">
        ...
        <tr class="ttr2">
            ...
            <td class="righttd">
                <input type="text" id="carNum" maxlength="20" runat="server" style="text-transform: uppercase"
                    onfocus="startCarnum()" />
                <asp:Label ID="txtCarNum" runat="server"></asp:Label>
            </td>
        </tr>
        <tr class="ttr1">
            <td class="lefttd">
        ...
        <tr class="ttr1">
            ...
            <td class="righttd bottomtd"><%--
                <asp:TextBox ID="TexBox_other1" runat="server" TextMode="MultiLine" Height="60px"
                    Width="300px"></asp:TextBox>--%>
                <textarea id="TexBox_other" runat="server"  ></textarea>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="lefttd" style="text-align: left;">
                <b>*</b><strong style="font-size: small">为必填项</strong>
            </td>
        </tr>
         <tr>
