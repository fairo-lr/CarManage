<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateCar.aspx.cs" Inherits="rightManage_updateCar" %>
...
<body style="font-size: 9pt;">
    <form id="Form1" runat="server" action="">
        ...
        <table class="addTable">
            <tr>
                <td style="width: 185px;" class="lefttd">
                    车类<b>*</b></td>
                <td class="righttd" style="width: 431px">
                    <asp:DropDownList ID="droplist_1" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="lefttd" style="width: 185px">
                    车牌号码<b>*</b></td>
                <td class="righttd" style="width: 431px">
            ...
            <tr>
                <td class="bottomtd lefttd" style="width: 185px; height: 22px">
                    一次性进出场<b>*</b></td>
                <td class="bottomtd righttd" style="width: 431px; height: 22px">
            ...
            <tr class="TMclass">
                <td align="center" class="lefttd toptd" style="width: 185px">
                    开始时间</td>
                <td class="righttd toptd" style="width: 431px">
            ...
            <tr class="TMclass">
                <td align="center" class="lefttd bottomtd" style="width: 185px">
                    结束时间
                </td>
                <td class="righttd bottomtd" style="width: 431px">
            ...
            <tr>
                <td valign="top" class="lefttd bottomtd" style="width: 185px">
                    备注</td>
                <td class="righttd bottomtd" style="width: 431px">
        ...
        <asp:Button ID="Button_update" Text="更新" runat="server" OnClick="updateData" />
        <asp:Label ID="Label_infoMation" runat="server" CssClass="label_css" ForeColor="red"></asp:Label>
