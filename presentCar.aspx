...
<body style="font-size: 9pt;">
    <form id="form1" runat="server">
        <h3 style="left: 12pt; position: absolute; top: 10pt;">
            车辆进出场记录</h3>
           ...
           <table class="carMainTable">
                <tr>
                    <td align="right">
                        ...
                        <input type="text" id="check_starTime" class="Wdate" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'check_endTime\')}',startDate:'%y-%M-%d 08:00:00',alwaysUseStartDate:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                            runat="server" />
</td><td>
                        <label>
                            至
                        </label>
                        <input type="text" id="check_endTime" runat="server" class="Wdate" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'check_starTime\')}',maxDate:'%y-%M-%d',startDate:'%y-%M-%d %H:00:00',alwaysUseStartDate:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
                    </td>
            ...
            <div>
                <asp:GridView ID="GridView_nowCar" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    EmptyDataText="No Records Found." Width="100%" HorizontalAlign="Center" OnRowDataBound="GridView_nowCar_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="InYardTime" HeaderText="进场时间" DataFormatString="{0:yy-MM-dd HH:mm}"
                            HtmlEncode="False" SortExpression="InYardTime" />
                        <asp:BoundField DataField="OutYardTime" HeaderText="出场时间" DataFormatString="{0:yy-MM-dd HH:mm}"
                            HtmlEncode="False" SortExpression="OutYardTime" />
                        <asp:BoundField HeaderText="违禁&lt;br /&gt;(Y/N)" HtmlEncode="False" DataField="illegalCar"
                            SortExpression="illegalCar" />
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDS_nowCar" runat="server" ProviderName="System.Data.Odbc"
                ConnectionString="DSN=carManage;DESC=MySQL ODBC 3.51 Driver DSN;DATABASE=testcar;SERVER=172.30.23.1;UID=root;PORT=3306;OPTION=3;STMT=;">
            </asp:SqlDataSource>
        </div>
